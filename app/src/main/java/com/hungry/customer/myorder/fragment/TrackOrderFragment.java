...
import com.hungry.customer.databinding.FragmentTrackOrderBinding;
import com.hungry.customer.myorder.model.Order;
import com.hungry.customer.myorder.viewModel.TrackOrderViewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       TrackOrderViewModel trackOrderViewModel= ViewModelProviders.of(this).get(TrackOrderViewModel.class);
        ...
        if (orderResult.status.equalsIgnoreCase("OPEN")){
            ...
            binding.icon.setImageResource(R.mipmap.step1);
            ...
            binding.icon.setImageResource(R.mipmap.step2);
            ...
            binding.icon.setImageResource(R.mipmap.step3);
            trackOrderViewModel.openProgress.setValue(100);
            ...
            binding.icon.setImageResource(R.mipmap.step4);
        }
            ...
            binding.icon.setImageResource(R.mipmap.canceled);
        }
            ...
            binding.icon.setImageResource(R.mipmap.rejected);
        }
        try {

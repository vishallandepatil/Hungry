package com.hungry.customer.myorder.adapter;
...
import com.hungry.customer.myorder.model.OrderItem;
...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyOrderAdapter.MyViewHolder holder, final int position) {
        ...
        for (OrderItem item: order.items) {
            ...
            price.setText(Curruncy.getCurruncy(item.getTotalPrice()+""));
        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Object obj) {
            binding.setVariable(com.hungry.customer.BR.order, obj);

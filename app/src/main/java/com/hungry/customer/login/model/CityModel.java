...
public class CityModel {
    ...
    public String getStatemaster_id() {
    ...
    public String getCity_name_slug() {
        return city_name_slug;
    }

    public String getCountrymaster_id() {
    ...
    String statemaster_id;
    String latitude;
    String longitude;
    String status;
    String city_name_slug;
    String countrymaster_id;
    String is_used;
